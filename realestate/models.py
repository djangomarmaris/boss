...
class Product(models.Model):
    ...
    type =models.ForeignKey(Type, on_delete=models.CASCADE,default=None,null=True,blank=True)
    city =models.ForeignKey(City, on_delete=models.CASCADE,default=None,null=True,blank=True)
    region =models.ForeignKey(Region, on_delete=models.CASCADE,default=None,null=True,blank=True)
